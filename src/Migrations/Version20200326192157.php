 ...
 */
final class Version20200326192157 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE purchase CHANGE created_at created_at DATETIME NOT NULL');
        $this->addSql('ALTER TABLE user ADD purchase_id VARCHAR(255) CHARACTER SET utf8 DEFAULT NULL COLLATE `utf8_unicode_ci`');
