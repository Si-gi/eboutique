...
class Purchase
{
    ...
    /**
     * @ORM\OneToOne(targetEntity="App\Entity\User", mappedBy="purchase", cascade={"persist", "remove"})
     */
    private $user;
    ...
    public function setUser(?User $user): self
    {
        ...
        $newPurchase = null === $user ? null : $this;
        if ($user->getPurchase() !== $newPurchase) {
            $user->setPurchase($newPurchase);
        }
